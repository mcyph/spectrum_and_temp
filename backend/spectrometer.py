...
def init():
    writeReg(0x04, 1)
    time.sleep(
        4)  # Experience was the on-board firmware needs a 2s delay after factory reset to get ready. If you poll it immediately you get [Errno 121] Remote I/O error
